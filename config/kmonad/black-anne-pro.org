...
(defsrc
  ...
  lctl lmet lalt           spc            ralt KeyCompose rctl  )
#+end_src
...
(deflayer fn
  ...
  tab  q    @mw  @me    r    @mt  y    u    i    @mo  p    [    ]    \
  lmet @ma  @ms  d    f    @mg  @kL  @kD  @kU  @kR  ;    '    ret
  lsft z    x    @mc  v    b    n    @mm    ,    .    /    @kU
  lctl lmet lalt           @smspace       @kL @kD @kR
)
#+end_src
